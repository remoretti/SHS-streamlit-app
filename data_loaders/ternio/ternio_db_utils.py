...
def map_ternio_to_harmonised():
    ...
    Mapping logic:
      ...
      - Select and rename columns as follows:
            ...
            "Paid"          AS "Sales Actual",
            "Comm Amount"              AS "Rev Actual",
...
commission_calculations AS (
    SELECT 
        ...
        mts."Paid",
        mts."Comm Amount",
        CAST((mts."Comm Amount" * crt."Commission tier 1 rate") AS NUMERIC(15,2)) AS "Comm Amount tier 1",
        CAST((mts."Comm Amount" * crt."Commission tier 2 rate" - mts."Comm Amount" * crt."Commission tier 1 rate") AS NUMERIC(15,2)) AS "Comm tier 2 diff amount",
        mts.row_hash
